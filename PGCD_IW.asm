...
code segment
  Assume cs:code, ds:data, ss:stack  
    ...
    PGCD_IW proc
       ...
       division:
       mov x,ax   ;le dernier dividende avant l'int 0 est le pgcd (dernier rest non nule)
       mov dx,0   ; div utilise le registre ax donc il faut mettre ah a 0 ainsi la valeur de ax sera la meme que al et n'est pas affecte le rest
       div bl
